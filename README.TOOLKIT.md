...
* stock-trader-app:StockTradingStateMachine
* stock-trader-app:StockCheckerFunction (python3.8)
* stock-trader-app:StockSellerFunction (python3.8)
* stock-trader-app:StockBuyerFunction (python3.8)
* stock-trader-app:TransactionTable
